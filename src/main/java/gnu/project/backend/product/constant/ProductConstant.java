...
public class ProductConstant {
    ...
    public static final String DETAIL_LENGTH = "상세 설명은 2000자 이하여야 합니다";
    public static final String STYLE_LENGTH = "스타일은 50자 이하여야 합니다";
    public static final String AVAILABLE_TIMES_LENGTH = "이용 가능 시간은 100자 이하여야 합니다";
    public static final String TYPE_LENGTH = "타입은 50자 이하여야 합니다";
    ...
    public static final int MAX_AVAILABLE_TIMES = 100;
    public static final int MAX_TYPE_LENGTH = 50;
    public static final int MAX_OPTION_COUNT = 10;
    public static final int MAX_OPTION_NAME_LENGTH = 50;
    public static final int MAX_OPTION_DETAIL_LENGTH = 200;
